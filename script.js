...
function answerYes() {
    ...
    document.getElementById("messageText").innerText = "Hey Shriya! 😊 Looking forward to when these holidays end. Can't wait to catch up and share some fun times together. How about we plan something exciting soon? Maybe a date soon...";
    showConfetti();
    setTimeout(showGif, 5000); // Show GIF after 5 seconds
}
...
function showGif() {
    ...
    iframeElement.setAttribute("src", "https://giphy.com/embed/Ze44chcCSUpyVN1gmQ/video");
